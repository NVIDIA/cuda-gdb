...
#ifdef NVIDIA_BUGFIX
      {
        /* We're jumping before the sigmask SIG_BLOCK, the current block mask will be saved.
           To prevent restoring the current blocked mask, we need to restore the previous mask. */
