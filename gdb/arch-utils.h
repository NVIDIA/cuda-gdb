...
extern CORE_ADDR default_segment_address_to_core_address (int address_class,
							  CORE_ADDR address);

extern CORE_ADDR
default_core_address_from_segment_address_and_type (CORE_ADDR segment_address,
						    struct type *type);
