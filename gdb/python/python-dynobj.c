...
#ifdef IS_PY3K
PyObject * (*gdbpy_PyMemoryView_FromObject) (PyObject *) = NULL;
...
#ifdef IS_PY3K
static PyObject * (*gdb_PyMemoryView_FromObject) (PyObject *) = NULL;
  ...
  for ( const auto& it : libpython3_flags )
    {
      ...
      for ( const auto& it : libpython3_end )
	{
	  const auto full_name = fname + it;
