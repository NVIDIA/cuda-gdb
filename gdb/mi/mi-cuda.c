...
void
mi_cmd_cuda_info_devices (char *command, char **argv, int argc)
{
...
void
mi_cmd_cuda_info_sms (char *command, char **argv, int argc)
{
  char *filter = concatenate_string (argv, argc);
...
void
mi_cmd_cuda_info_warps (char *command, char **argv, int argc)
{
  char *filter = concatenate_string (argv, argc);
...
void
mi_cmd_cuda_info_lanes (char *command, char **argv, int argc)
{
  char *filter = concatenate_string (argv, argc);
...
void
mi_cmd_cuda_info_kernels (char *command, char **argv, int argc)
{
  char *filter = concatenate_string (argv, argc);
...
void
mi_cmd_cuda_info_threads (char *command, char **argv, int argc)
{
  char *filter = concatenate_string (argv, argc);
...
void
mi_cmd_cuda_focus_query (char *command, char **argv, int argc)
{
...
void
mi_cmd_cuda_focus_switch (char *command, char **argv, int argc)
{
