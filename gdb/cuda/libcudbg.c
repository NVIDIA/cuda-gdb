...
static CUDBGResult
cudbgSingleStepWarp65 (uint32_t dev, uint32_t sm, uint32_t wp, uint32_t nsteps, uint64_t *warpMask)
{
    char *ipc_buf;
    CUDBGResult result;
    ...
    CUDBG_IPC_PROFILE_END(CUDBGAPIREQ_singleStepWarp65, "singleStepWarp65");
...
static CUDBGResult
cudbgGenerateCoredump (const char *filename, CUDBGCoredumpGenerationFlags flags)
{
    ...
    CUDBG_IPC_PROFILE_END(CUDBGAPIREQ_generateCoredump, "generateCoredump");

    return result;
}

static CUDBGResult
cudbgGetConstBankAddress123 (uint32_t dev, uint32_t sm, uint32_t wp, uint32_t bank, uint32_t offset, uint64_t* address)
{
    char *ipc_buf;
    CUDBGResult result;
    ...
    CUDBG_IPC_PROFILE_END(CUDBGAPIREQ_getConstBankAddress, "getConstBankAddress123");
...
cudbgGetDeviceInfoSizes (uint32_t dev, CUDBGDeviceInfoSizes *sizes)
{
    ...
    CUDBG_IPC_PROFILE_END(CUDBGAPIREQ_getDeviceInfoSizes, "getDeviceInfoSizes");
		    ...
		    void *buffer, uint32_t size, uint32_t *data_length)
{
    ...
    CUDBG_IPC_PROFILE_END(CUDBGAPIREQ_getDeviceInfo, "getDeviceInfo");

    return result;
}

static CUDBGResult
cudbgGetConstBankAddress (uint32_t dev, uint64_t gridId64, uint32_t bank, uint64_t* address, uint32_t* size)
{
    char *ipc_buf;
    CUDBGResult result;
...
static CUDBGResult
cudbgSingleStepWarp (uint32_t dev, uint32_t sm, uint32_t wp, uint32_t laneHint, uint32_t nsteps, uint32_t flags, uint64_t *warpMask)
{
    char *ipc_buf;
    CUDBGResult result;
...
static CUDBGResult
cudbgReadAllVirtualReturnAddresses (uint32_t dev, uint32_t sm, uint32_t wp, uint32_t ln, uint64_t *addrs, uint32_t numAddrs, uint32_t *callDepth, uint32_t *syscallCallDepth)
{
    char *ipc_buf;
    CUDBGResult result;
    ...
    CUDBG_IPC_PROFILE_END(CUDBGAPIREQ_readAllVirtualReturnAddresses, "readAllVirtualReturnAddresses");
...
cudbgGetSupportedDebuggerCapabilities (CUDBGCapabilityFlags* capabilities)
{
    ...
    CUDBG_IPC_PROFILE_END(CUDBGAPIREQ_getSupportedDebuggerCapabilities, "getSupportedDebuggerCapabilities");
		      ...
		      uint64_t *errorPC, bool *errorPCValid)
{
  ...
  CUDBG_IPC_PROFILE_END (CUDBGAPIREQ_readSmException, "readSmException");
