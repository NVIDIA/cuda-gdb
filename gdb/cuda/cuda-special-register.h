...
void cuda_special_register_read (regmap_t regmap, gdb_byte *buf);
void cuda_special_register_write (regmap_t regmap, const gdb_byte *buf);

/* read/write from/to special_register to/from value */
void cuda_special_register_to_value (regmap_t regmap, frame_info_ptr frame,
				     gdb_byte *to);
void cuda_value_to_special_register (regmap_t regmap, frame_info_ptr frame,
				     const gdb_byte *from);
