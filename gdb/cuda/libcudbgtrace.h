  ...
  switch (*value)
    {
      ...
      CASE_PRINT_ENUM_VALUE (CUDBG_EXCEPTION_INVALID_MANAGED_MEMORY_ACCESS) break;
      ...
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_MISALIGNED_PC) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_PC_OVERFLOW) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_MISALIGNED_REG) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_ILLEGAL_INSTR_ENCODING) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_ILLEGAL_INSTR_PARAM) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_OUT_OF_RANGE_REGISTER) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_INVALID_CONST_ADDR_LDC) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_MMU_FAULT) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_ARRIVE) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_CLUSTER_POISON) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_API_STACK_ERROR) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_BLOCK_NOT_PRESENT) break;
      CASE_PRINT_ENUM_VALUE(CUDBG_EXCEPTION_WARP_USER_STACK_OVERFLOW) break;
      CASE_PRINT_ENUM_DEFAULT (*value) break;
    }
  fflush (s_traceFile);
}
