...
const struct frame_base *cuda_frame_base_sniffer (const frame_info_ptr &next_frame);

bool cuda_frame_p (frame_info_ptr next_frame);
bool cuda_frame_outermost_p (frame_info_ptr next_frame);

CORE_ADDR cuda_unwind_pc (struct gdbarch *gdbarch, const frame_info_ptr &next_frame);
